...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
  ...
  <div className="w-full min-h-[320px] border border-neutral-300 bg-white">
    ...
    <div className="p-5">
      <p className="text-gray-700 leading-8 text-lg">
        Official live coverage, city broadcasts, interviews, and press
        conferences are managed directly by SANews operational teams.
      </p>
    </div>
  </div>
  ...
  <div className="w-full min-h-[320px] border border-neutral-300 bg-white">
    ...
    <div className="p-5">
      <p className="text-gray-700 leading-8 text-lg">
        The SANews newsroom system handles reports, investigative articles,
        media releases, and official publication management.
      </p>
    </div>
  </div>
  ...
  <div className="w-full min-h-[320px] border border-neutral-300 bg-white">
    ...
    <div className="p-5">
      <p className="text-gray-700 leading-8 text-lg">
        SANews provides paid promotion, media partnerships, event coverage,
